...
export async function createHotel(prevState: any, formData: FormData) {
    ...
    try {
        ...
        console.error('error to create hotel: ', error);
        return {
            ...prevState,
            message: 'Não foi possivel cadastrar o hotel',
            error: true
        }
    }
...
export async function updateHotel(prevState: any, formData: FormData) {
    ...
    try {
        ...
        console.error('error to update hotel: ', error);
        return {
            ...prevState,
            message: 'Não foi possivel atualizar o hotel',
            error: true
        }
    }
